...
const API_BASE_URL = 'https://us-central1-farmbase-b2f7e.cloudfunctions.net';
const API_TOKEN = 'fn_live_1748264194699_PjyYUjTRbH6EKHxyWhKgJFt8m0dm2lhx';
...
export const getForecastWeather = async (fieldID: string): Promise<WeatherData> => {
  try {
    const response = await fetch(`${API_BASE_URL}/getForecastWeather`, {
      ...
      body: JSON.stringify({ FieldID: "1752169888334" }),
    });
